...
const AboutMe = React.forwardRef<HTMLDivElement>((props, ref) => {
    return (
        <div
            ref={ref}
            className="h-max flex justify-around items-center flex-col md:flex-row bg-opacity-70 bg-black md:h-screen"
        >
            <div className="max-w-screen-md mx-auto text-center md:text-left mb-10 md:mb-0 px-6 md:pl-12">
                ...
                <p className="text-md text-justify md:text-xl text-white mb-8">
                    Greetings! I'm a tech enthusiast based in Ahmedabad. With a
                    solid foundation in programming, I'm passionate about web
                    development. I have recently finished my Postgrad degree and
                    Masters degree and I'm currently looking for a job.
                    Embracing my rookie status in this domain, I'm eager for the
                    learning journey ahead. I thrive on challenges and am poised
                    to dive headfirst into the world of web development. Let's
                ...
                <div className="mb-10">
                    ...
                    {workex.map((work, index) => (
                        <div key={index} className="mb-6">
                            <h3 className="text-lg md:text-xl text-orange-400 mb-1">
                                {work.company}
                            </h3>
                            <h4 className="text-base md:text-lg text-white mb-1">
                                {work.position}
                            </h4>
